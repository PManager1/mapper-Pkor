...
const ClientSearch = (props) => {
  ...
  function enterPressed(e) {
    console.log('54 in fun enterPressed  e.target =', e);
    // console.log('55 any button  pressed  event =', e.target.textContent);

    let str = e.target.textContent;
    console.log('57 any button  pressed  str =', str);
  ...
  return (
    <div style={{ width: 950, marginLeft: 20 }}>
      <Autocomplete
        ...
        disableOpenOnFocus
        renderInput={params => (
          <TextField {...params} label="Search by Clients" margin="normal" fullWidth />
        )}
      />
